...
EXTRACT_DESTINATION = os.path.join(config.abs_path, "data/chinese_dialect_lexicons/")
OPENCC_FILE_PATH = os.path.join(config.abs_path, "data/chinese_dialect_lexicons/zaonhe.json")
