...
EXTRACT_DESTINATION = os.path.join(BASE_DIR, "data/chinese_dialect_lexicons/")
OPENCC_FILE_PATH = os.path.join(BASE_DIR, "data/chinese_dialect_lexicons/zaonhe.json")
