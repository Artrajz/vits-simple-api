...
EXTRACT_DESTINATION = os.path.join(config.ABS_PATH, "vits/text/chinese_dialects_lexicons/")
EXPECTED_MD5 = None
OPENCC_FILE_PATH = os.path.join(config.ABS_PATH, "vits/text/chinese_dialects_lexicons/jyutjyu.json")
